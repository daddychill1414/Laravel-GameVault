 ...
 * StoreGameRequest
 *
 * Validates incoming data when creating a new game.
 * Demonstrates Laravel Form Request validation — rules are defined here
 * instead of in the controller, keeping the controller clean.
 */
class StoreGameRequest extends FormRequest
{
     ...
     *
     * Returns true because this app has no authentication.
     */
